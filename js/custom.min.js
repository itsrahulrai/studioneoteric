var ArchCode = function () {
    ...
    var e = $(window).width(),
        ...
        p = new Date;
    monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], p.setMonth(p.getMonth() + 1), p = p.getDate() + " " + monthNames[p.getMonth()] + " " + p.getFullYear();
    var h = function () {
        ...
        //                 pointerColor: "#750c7e",
        //                 ringSize: 15,
        //                 ringClickSize: (s.ringSize || 15) - 5
        //             };
        //             return void 0 == s[e] ? t[e] : s[e]
        //         },
        //             u = () => {
        //                 void 0 != i && (o = c(o, i, .2), a = c(a, n, .2), document.querySelector(".p-action-click:hover") ? (e.style.borderColor = d("pointerColor"), r = !0) : (e.style.borderColor = "white", r = !1), t.style.borderColor = d("pointerColor"), l ? t.style.padding = d("ringClickSize") + "px" : t.style.padding = d("ringSize") + "px", e.style.transform = `translate(${i}px, ${n}px)`, t.style.transform = `translate(${o - (l ? d("ringClickSize") : d("ringSize"))}px, ${a - (l ? d("ringClickSize") : d("ringSize"))}px)`, requestAnimationFrame(u))
        //             };
    ...
    return {
        init: function () {
            v(), i(), n(), t(), o(), a(), r(), c(), d(), m(p), u(), g(), h(),  C(), jQuery(".modal").on("show.bs.modal", f)
        },
        load: function () {
            s(), l(), b()
        },
...
jQuery(document).ready(function () {
    "use strict";
    ArchCode.init(), $('a[data-toggle="tab"]').click(function () {
